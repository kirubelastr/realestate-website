    ...
    <MaxWidthWrapper>
      <div className="py-20 mx-auto text-center flex flex-col items-center max-w-3xl">
        ...
        <p className="mt-6 text-lg max-w-prose text-muted-foreground">
          Welcome to ethiopian realestate. Every apartment on our 
          platform is listed by a verified sales agents of ethiopian 
          realestate company.
        </p>
      ...
      {/* to do list of apartments or products */}
    </MaxWidthWrapper>
    <section className="border-t border-primary bg-secondary">
